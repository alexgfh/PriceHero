...
//received the post from webhook
$data = json_decode(file_get_contents('php://input'), true);

error_log(' ');
error_log($data['receipthero_id']);
error_log($data['notification_type']);
error_log($data['receipt_id']);
error_log(' ');

$receipthero_id =  $data['receipthero_id'];
...
Must get all users to found OAuth key
Another option could be store this data
*/
...
$result = json_decode($result, true)['results'][$receipthero_id];
//var_dump($result);
